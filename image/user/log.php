...
.left_dbms{margin-left:40px;}
@media only screen and (max-width: 600px) {
.logindiv {
    position: relative;
    margin: auto;
    margin-top: 18vh;
    width: clamp(315px, 30%, 419px);
    height: clamp(470px, 50%, 450px);
    background-color: #C7E8CA;
    border-radius: 35px;
    box-sizing: content-box;
...
.paragr{
  ...
  <div class="form">
    <h1>Log-in</h1>
        <form action ="home.php" method="post" class="left_dbms">
      <div class="form-item">
...
<h6 class="paragr">I d'not have account for click <a href="sign.php">Sign up</a></h6>
</form>
</div>
  </div>
</div>
