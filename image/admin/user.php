...
<h3 class="label_25">Manage user</h3>
<section class="river">
<table class="table table-striped table-hover makeEditable" id="top_server" >
  ...
  if ($db->connect_error) { 
    die("Connection failed: " . $db->connect_error); 
           ...
           $qry = "SELECT * FROM `signup` WHERE 1";
           $count = 1;  
